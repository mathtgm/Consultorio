...
<html>
	...
	<body>
		<div class="bg-login">
			<div class="cardLogin">
				<div class="d-flex justify-content-center"><span class="h1">Painel do usuário</span></div>
				<div class="d-flex justify-content-center"><img class="logo" src="/SistemaConsultorio/Sistema/view/images/logo-example.png"></div>
